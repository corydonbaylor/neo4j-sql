...
('The Devils Advocate', 1997, 'Evil has its winning ways'),
('A Few Good Men', 1992, 'In the heart of the nations capital, in a courthouse of the U.S. government, one man will stop at nothing to keep his honor, and one will stop at nothing to find the truth.'),
('Top Gun', 1986, 'I feel the need, the need for speed.'),
('Jerry Maguire', 2000, 'The rest of his life begins now.'),
('Stand By Me', 1986, 'For some, its the last real taste of innocence, and the first real taste of life. But for everyone, its the time that memories are made of.'),
...
('Youve Got Mail', 1998, 'At odds in life... in love on-line.'),
...
('RescueDawn', 2006, 'Based on the extraordinary true story of one mans fight for freedom'),
('The Birdcage', 1996, 'Come as you are'),
('Unforgiven', 1992, 'Its a hell of a thing, killing a man'),
...
('The Green Mile', 1999, 'Walk a mile youll never forget.'),
('Frost/Nixon', 2008, '400 million people were waiting for the truth.'),
('Hoffa', 1992, 'He didnt want law. He wanted justice.'),
('Apollo 13', 1995, 'Houston, we have a problem.'),
('Twister', 1996, 'Dont Breathe. Dont Look Back.'),
('Cast Away', 2000, 'At the edge of the world, his journey begins.'),
('One Flew Over the Cuckoos Nest', 1975, 'If hes crazy, what does that make you?'),
('Bicentennial Man', 1999, 'One robots 200 year journey to become an ordinary man.'),
('Charlie Wilsons War', 2007, 'A stiff drink. A little mascara. A lot of nerve. Who said they couldnt bring down the Soviet empire.'),
...
('Parasite', 2019, 'Act like you own the place'),
